...
dependencies {
    compile(name: 'mijiaClient-3-3-12', ext: 'aar')
    compile(name: 'mijiaService-3-3-12', ext: 'aar')
    compile(name: 'mijiaBluetooth-3-3-12', ext: 'aar')
...
dependencies {
    compile 'com.miot.bluetooth:mijia:3.3.12@aar'
    compile 'com.miot.api:mijia:3.3.12@aar'
    compile 'com.miot.service:mijia:3.3.12@aar'
    compile 'com.google.code.gson:gson:2.4'
    compile 'commons-io:commons-io:2.4'
    compile 'com.squareup.okhttp:okhttp:2.5.0'
    compile 'javax.jmdns:jmdns:3.4.1'
