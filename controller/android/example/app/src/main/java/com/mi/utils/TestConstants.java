...
public class TestConstants {
    ...
    public static final String CHUANGMI_PLUG_V1_URL = "chuangmi.plug.v1.xml";              // 小米智能插座

    public static final String CHUANGMI_PLUG_M1 = "chuangmi.plug.m1";              // 小米智能插座基础版
    public static final String CHUANGMI_PLUG_M1_URL = "chuangmi.plug.m1.xml";              // 小米智能插座基础版
