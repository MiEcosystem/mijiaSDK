...
//    public SmartSocketBaseService mySmartSocketBaseService = new SmartSocketBaseService(this);
    ...
    private boolean init(Device device) {
        ...
        do {
            ...
            Service svcSmartSocketBaseService = device.getService(SERVICE_SmartSocketBaseService);
            if (svcSmartSocketBaseService == null) {
                break;
            }
//            this.mySmartSocketBaseService.setService(svcSmartSocketBaseService);

            this.setDevice(device);

//            this.actionPermission = device.getActionPermission();
//            this.mySmartSocketBaseService.setActionPermission(actionPermission);
    ...
    // Parcelable 
    //-------------------------------------------------------
    public static final Parcelable.Creator<SmartSocketBase> CREATOR = new Parcelable.Creator<SmartSocketBase>() {
